    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-sidebar border-r border-border">
            ...
            <ul class="py-5 list-none">
                ...
                <li>
                    <a href="admin-mi-horario.php" class="sidebar-link active flex items-center py-3 px-5 text-gray-800 no-underline transition-all hover:bg-sidebarHover">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <section class="flex-1 px-6 py-8">
                <div class="max-w-6xl mx-auto">
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-lightborder p-6 mb-6">
                        <h3 class="text-lg font-medium text-gray-900 mb-4"><?php _e('view_as_teacher'); ?></h3>
                        <div class="flex gap-4">
                            ...
                            <button onclick="loadDocenteHorario()" 
                    ...
                    <div class="bg-white rounded-lg shadow-sm overflow-hidden border border-lightborder">
                        <div class="p-4 border-b border-gray-200 bg-gray-50">
                            <h3 class="font-medium text-darktext"><?php _e('weekly_schedule'); ?></h3>
                        </div>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <?php foreach ($dias as $dia): ?>
                                                <td class="text-center font-medium p-2 border border-gray-300">
                                                    <?php 
