    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-sidebar border-r border-border">
            ...
            <ul class="py-5 list-none">
                ...
                <li>
                    <a href="admin-mi-disponibilidad.php" class="sidebar-link active flex items-center py-3 px-5 text-gray-800 no-underline transition-all hover:bg-sidebarHover">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
            ...
            <section class="flex-1 px-6 py-8">
                <div class="max-w-6xl mx-auto">
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-lightborder p-12 text-center">
                        <svg class="mx-auto h-16 w-16 text-darkblue mb-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
