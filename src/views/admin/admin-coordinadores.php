...
<head>
  ...
  <title>Sistema de Horarios SIM — Admin · Coordinadores</title>
  ...
  <div class="flex min-h-screen">
    ...
    <aside class="w-64 bg-card border-r border-border">
      ...
      <ul class="py-5 list-none">
        ...
        <li>
          <a href="admin-coordinadores.html" class="flex items-center py-3 px-5 text-gray-600 no-underline transition-all hover:bg-hover hover:text-gray-800 bg-hover text-darkblue font-medium">
    ...
    <main class="flex-1 flex flex-col">
      ...
      <section class="flex-1 px-6 py-8 flex justify-center">
        <div class="w-full max-w-4xl flex flex-col">
          <div class="mb-8">
            <h2 class="text-darktext text-2xl font-semibold mb-2.5">Registros de Coordinadores</h2>
            <p class="text-muted mb-6 text-base">Lista de todos los Coordinadores registrados.</p>
          </div>
          ...
          <div class="bg-white rounded-lg shadow-sm overflow-hidden border border-lightborder">
            <article class="flex items-center p-4 border-b border-gray-200 transition-colors hover:bg-lightbg">
              ...
              <div class="meta">
                ...
                <div class="text-muted text-sm">Coordinador</div>
              </div>
            </article>
            ...
            <article class="flex items-center p-4 transition-colors hover:bg-lightbg">
              ...
              <div class="meta">
                ...
                <div class="text-muted text-sm">Coordinadora</div>
              </div>
            </article>
          </div>
        </div>
