    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-sidebar border-r border-border">
            ...
            <ul class="py-5 list-none">
                ...
                <li>
                    <a href="admin-publicar-horarios.php" class="sidebar-link active flex items-center py-3 px-5 text-gray-800 no-underline transition-all hover:bg-sidebarHover">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
