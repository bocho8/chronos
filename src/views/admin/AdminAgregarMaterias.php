    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 flex flex-col">
            ...
            <header class="bg-darkblue px-6 h-[60px] flex justify-between items-center shadow-sm border-b border-lightborder">
                ...
                <div class="text-white text-lg md:text-xl font-semibold text-center hidden sm:block"><?php _e('add_new_subjects'); ?></div>
                <div class="text-white text-sm font-semibold text-center sm:hidden"><?php _e('add_new_subjects'); ?></div>
