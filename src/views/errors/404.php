...
<body class="bg-bg font-sans text-gray-800 leading-relaxed">
    ...
    <main class="flex items-center justify-center min-h-[calc(100vh-60px)] p-6">
        <div class="text-center max-w-md mx-auto">
            <div class="mb-8">
                <h1 class="text-9xl font-bold text-navy mb-4">404</h1>
                <h2 class="text-3xl font-bold text-gray-800 mb-4"><?php _e('error_404_heading'); ?></h2>
                <p class="text-lg text-gray-600 mb-8"><?php _e('error_404_message'); ?></p>
            </div>
