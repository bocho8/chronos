...
<head>
    ...
    <title><?php _e('app_name'); ?> — <?php _e('director_dashboard'); ?></title>
    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 flex flex-col main-content">
            <header class="bg-darkblue px-4 md:px-6 h-[60px] flex justify-between items-center shadow-sm border-b border-lightborder">
                ...
                <div class="text-white text-lg md:text-xl font-semibold text-center hidden sm:block"><?php _e('welcome'); ?>, <?php echo htmlspecialchars(AuthHelper::getUserDisplayName()); ?> (<?php _e('role_director'); ?>)</div>
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50 hidden group-hover:block" id="userMenu">
                            <div class="px-4 py-2 text-sm text-gray-700 border-b">
                                ...
                                <div class="text-gray-500"><?php _e('role_director'); ?></div>
                            </div>
