...
COMMENT ON TABLE usuario IS 'Usuarios del sistema con información básica';
...
-- Insert default ANEP guidelines
INSERT INTO pauta_anep (id_pauta_anep, nombre, dias_minimos, dias_maximos, condiciones_especiales) VALUES
